...
public class AdminPostSearchPageUI {
	...
	public static final String SEARCH_POSTS_BUTTON = "css=#post-search-submit";
	...
	public static final String ROW_TITLE_DETAIL = "xpath=//table[contains(@class,'table-view-list posts')]/tbody/tr//a[@class='row-title' and text()='%s']";
